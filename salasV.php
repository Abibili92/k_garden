<?php
  ...
  $query2 = "SELECT publicacion_id, reaccion, COUNT(*) as count 
  FROM reacciones 
...
<style>
  .cartelT {
    background-color: <?php echo htmlspecialchars($sala['Color']); ?>; /* Violeta normal */
    color: white;
...
.btnT:hover {
    background-color: <?php echo htmlspecialchars($sala['hover']); ?>; /* Violeta oscuro */
}
...
.table thead th {
    ...
    font-family: "Questrial", sans-serif;
    padding: 10px;
    border: 1px solid <?php echo htmlspecialchars($sala['Color']); ?>; /* Violeta normal */
}
...
.reacciones:hover {
    background-color: <?php echo htmlspecialchars($sala['hover']); ?>; /* Violeta más oscuro */
    border-radius: 20px;
}
  ...
  <header class="n2 d-flex flex-wrap align-items-center">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="salasV.php" style="background-color:<?php echo htmlspecialchars($sala['Color']); ?>;"><?php echo htmlspecialchars($sala['Salas']); ?></a></li>
      ...
      <div class="mt-3 mt-md-0">
        ...
        <div class="mt-3 mt-md-0">
            <div class="carter">
                <div class="card text-center-left">
                    <div class="card-body">
                        <h4 class="color"><?php echo htmlspecialchars($sala['Salas']); ?></h5>
                        <p class="card-text texi">
