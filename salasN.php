  ...
  <header class="n2 d-flex flex-wrap align-items-center">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="salasN.php"  style="background-color:<?php echo htmlspecialchars($sala['Color']); ?>;"><?php echo htmlspecialchars($sala['Salas']); ?></a></li>
    ...
    <div class="cartelN d-flex justify-content-center">
      ...
      <div class="mt-3 mt-md-0">
        <div class="carter">
            <div class="card text-center-left">
                <div class="card-body">
                    <h5 class="orange text-center">Proyectos</h5>
                    ...
                    <div id="project-cards">
                        ...
                        if ($result->num_rows > 0) {
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<h5 class="orange">' . $row['Nombre'] . '</h5>';
        ...
        <div class="mt-3 mt-md-0">
            <div class="carter">
                <div class="card text-center-left">
                    <div class="card-body">
                        <h5 class="orange"><?php echo htmlspecialchars($sala['Salas']); ?></h5>
                        <p class="card-text">
                        <?php echo htmlspecialchars($sala['texto']); ?><br><br>
                        <?php echo htmlspecialchars($sala['texto2']); ?> 
                        </p>
                        <button class="btnO">Horarios</button>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title orange">Horarios<?php echo htmlspecialchars($sala['Salas']); ?></h5>
