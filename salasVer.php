...
.color2 {
    color: <?php echo htmlspecialchars($sala['Color']); ?>; /* Verde normal */
    font-family: "Questrial", sans-serif;
}
...
.btnT:hover {
    background-color: <?php echo htmlspecialchars($sala['hover']); ?>; /* Verde oscuro */
}

.table thead th {
    background-color:<?php echo htmlspecialchars($sala['Color']); ?>; /* Verde normal */
    color: white;
    font-family: "Questrial", sans-serif;
    padding: 10px;
    border: 1px solid<?php echo htmlspecialchars($sala['Color']); ?>; /* Verde normal */
}

.table tbody td {
    padding: 10px;
    border: 1px solid<?php echo htmlspecialchars($sala['Color']); ?>; /* Verde normal */
    background-color: #f0f0f0; /* Gris claro para contraste */
}
...
.reacciones:hover {
    background-color: <?php echo htmlspecialchars($sala['hover']); ?>; /* Verde más oscuro */
    border-radius: 20px;
}
...
<body>
  ...
  <header class="container-fluid">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div>
          <button class="net m-0"><i class="fab fa-facebook"></i></button>
          <button class="net m-0"><i class="fab fa-whatsapp"></i></button>
          <button class="net m-0"><i class="fas fa-envelope"></i></button>
          <button class="net m-0"><i class="fab fa-instagram"><a href="https://www.instagram.com/jardin901sanclemente?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="></a></i></button>
        </div>
    </div>
  </header>
